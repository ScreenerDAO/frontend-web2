...
import { IElement, IElementsGroup, balanceSheetStructure, balanceSheetTypesNames, getFinancialStatementStructureFromCustomLabels, getFinancialStatementStructureFromCustomLabelsV2 } from 'src/types/FinancialStatementsTypes';
